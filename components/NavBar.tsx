...
export function NavBar() {
  ...
  return (
    <header className="header">
      <div className="container mx-auto flex w-full max-w-5xl items-center justify-between px-4">
        ...
        >
          ...
          <button
            className={`absolute right-6 top-4 flex text-2xl sm:hidden`}
            onClick={toggle}
          >
            <svg
        ...
        <button className={`flex text-2xl sm:hidden`} onClick={toggle}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="1em"
            viewBox="0 0 448 512"
